...
'verb-to-be':{
  ...
  slots:{
    ...
    use:{yes:['name & age','feelings','where you are / are from','jobs & descriptions'],no:['actions (I work ✗ I am work)','age with "have"','"I am agree"']},
  ...
  warmup:{
    gap:['Tell me about you — who... you?','Your best friend: how old...?','Your city: what... it like?'],
  ...
  ccqs:{
    main:[
      ...
      {q:'"I\'m a teacher." — Is "\'m" a different word from "am"?',a:'no — same word, short'},
  ...
  rule:{
    ...
    pron:'Contractions are the real English: I\'m /aɪm/, she\'s /ʃiːz/, they\'re /ðer/. Full forms sound robotic.',
  ...
  watchout:[
    ...
    {bad:'I am agree',good:'I agree',why:'agree é ação — sem be'},
    {bad:'They is my friends',good:'They ARE my friends',why:'they → are, sempre'}
  ],
  practice:[
    {t:'fill',q:'I ___ {name}, and I ___ a student.',a:'am / am',hint:'Same word twice — the "I" word.',fu:'Now say it about ME.'},
    {t:'fill',q:'My best friend ___ very funny.',a:'is',hint:'One person → i...',fu:'Really? Tell me one funny thing they do!'},
    ...
    {t:'mc',q:'"___ you tired today?"',opts:['Is','Am','Are'],a:'C — Are',hint:'you → always the same word.',fu:'So — ARE you? Why?'},
    ...
    {t:'ec',q:'You is my teacher.',a:'You ARE my teacher.',hint:'you never goes with is.',fu:'Say one more thing about me with "are".'},
    {t:'tr',q:'Make it negative: "I am tired."',a:'I am NOT tired. / I\'m not tired.',hint:'Add one small word after am.',fu:'Is it true? Are you tired?'},
  ...
  makeit:['I am ______ (how do you feel right now?).','My favorite person is ______ because...','My ______ and I are... (family/friends)','Right now, my phone is... (where? how?)','One thing in my house that is very old is...','Ask ME: "Are you...?" — anything you want!'],
  task:{
    title:'The Interview',
    ...
    c4:'Formal version: it\'s a JOB interview now — "I am organized, I am from..., my strengths are..." Same verb, new register.'
  },
  exit:[
    {tag:'🗣 speak',q:'In 4 sentences: who are you? (name, age, from, one feeling)'},
    {tag:'🗣 speak',q:'Describe one person of your family: who is he/she? how old? how is he/she today?'},
    {tag:'✏ create',q:'Make a sentence about US with "are".'},
    {tag:'✏ create',q:'Make a NEGATIVE sentence about your city.',a:'ex: My city isn\'t small.'},
...
'present-simple':{
  ...
  slots:{
    ...
    use:{yes:['every day / always / usually','routines & habits','facts ("the sun rises...")','likes & dislikes'],no:['happening right now (→ continuous)','yesterday (→ past)']},
  ...
  warmup:{
    gap:['What... you... every morning? (tente contar!)','Your best friend — what... he/she... on weekends?','Tell me one thing you do EVERY single day.'],
  ...
  ccqs:{
    main:[
      {q:'"I drink coffee every morning." — Am I drinking coffee right now?',a:'not necessarily — habit'},
  ...
  practice:[
    ...
    {t:'mc',q:'"They ___ in Curitiba."',opts:['lives','live','living'],a:'B — live',hint:'they → base verb.',fu:'Where do your grandparents live?'},
    ...
    {t:'us',q:'every day / English / studies / {name}',a:'{name} studies English every day.',hint:'Who first, time last.',fu:'True? How many days really?'},
    {t:'us',q:'don\'t / TV / we / watch / much',a:'We don\'t watch much TV.',hint:'don\'t before the verb.',fu:'And in YOUR house?'},
  ...
  task:{
    ...
    kid:'You are a detective! 🕵️ Ask me about my day (7+ questions) and find my SECRET habit. Wrong questions = no clues!',
    ...
    c4:'Switch: now the detective (you, teacher) interrogates {name} — student answers under pressure with full sentences, then WRITES the case report aloud in 4 sentences.'
  },
  exit:[
    {tag:'🗣 speak',q:'Your perfect Saturday: 4 sentences about what you do.'},
    {tag:'🗣 speak',q:'One person of your family: 3 things he/she does every week.'},
    ...
    {tag:'💭 concept',q:'Present Simple: when yes, when no? One example of each.',a:'rotina/fato sim ("I work every day"); agora não ("I\'m working now")'}
  ]
},
...
'present-continuous':{
  ...
  notice:{
    ...
    hints:['Underline am/is/are... and then what ending?','Cover the -ing — does "I am talk" sound complete?','Two hypotheses: (A) be + -ing together · (B) only -ing. Test both.']
  },
  ccqs:{
    main:[
  ...
  practice:[
    {t:'fill',q:'Right now, I ___ (talk) to my teacher.',a:'am talking',hint:'Two pieces: am + ...ing.',fu:'And what ELSE are you doing right now?'},
    ...
    {t:'mc',q:'"Look! It ___."',opts:['rains','is raining','raining'],a:'B — is raining',hint:'"Look!" = this second.',fu:'Why not A? What\'s the weather NOW where you are?'},
    {t:'mc',q:'"___ you listening to me?"',opts:['Do','Is','Are'],a:'C — Are',hint:'you → are, first position.',fu:'ARE you? Prove it — what did I just say? 😄'},
    ...
    {t:'us',q:'is / my / barking / dog / again',a:'My dog is barking again.',hint:'Whose dog first.',fu:'What sounds can you hear right now? Use -ing!'},
  ...
  makeit:['Right now, I am ______ and also ______ (two things!).','My ______ (person) is probably ______ at this moment.','This week, I am ______ (something temporary).','Outside my window, ______ is/are ______ right now.','I am NOT ______ right now — but I want to be!','Ask ME: "Are you...?" — about this exact moment.'],
  task:{
    ...
    complication:'Mid-scene, the "signal drops" — the commentator must summarize in 3 sentences what WAS happening when it returns.',
    extras:['A second "camera" (teacher points at things in the student\'s room): narrate what is happening THERE.','Slow-motion replay: narrate the best moment again, slower and with more detail.'],
...
'past-simple':{
  ...
  slots:{
    ...
    use:{yes:['yesterday / last week / in 2020','finished actions','stories ("first..., then...")'],no:['with "since/for + now" (→ perfect)','still true now (→ present)']},
  ...
  warmup:{
    gap:['Yesterday — what... you...? (tente me contar!)','Last weekend: where...?','Your last meal: what... you...?'],
    kidGame:'Yesterday mime! Act 3 things you did yesterday — I guess.',
    hint:'"Yesterday I..." + verb — stretch it: "play...?"'
  },
  notice:{
    examples:['Yesterday I <b>worked</b> a lot.','{name} <b>studied</b> English last week.','We <b>talked</b> about movies on Monday.','My friend <b>didn\'t answer</b> my message.'],
    altExamples:['Last night I <b>watched</b> a series.','She <b>cooked</b> dinner yesterday.','They <b>played</b> together last Sunday.','I <b>didn\'t like</b> the movie.'],
    ...
    hints:['Underline the last 2 letters of worked, studied, talked.','Compare: "I work" (today) / "I workED" (?) — when is the -ed one?','In "didn\'t answer" — where did the -ed go? Who carries the past now?']
  },
  ccqs:{
    main:[
      ...
      {q:'"I didn\'t play." — Did the game happen for me?',a:'no'},
  ...
  rule:{
    ...
    pron:'-ed has 3 sounds: worked /t/ · played /d/ · wanted /ɪd/. Only -ted/-ded get the extra syllable — "workED" com "É" no fim é o sotaque nº1 do brasileiro.',
    pt:'Como o "-ou/-ei" do português (trabalhou, joguei) — mas no negativo o did rouba o passado do verbo: didn\'t work (não "didn\'t worked").',
  ...
  practice:[
    ...
    {t:'mc',q:'"I ___ like the food."',opts:['didn\'t liked','didn\'t like','don\'t liked'],a:'B — didn\'t like',hint:'did came → -ed goes.',fu:'Why not A? Tell me a food you didn\'t like as a kid.'},
    {t:'us',q:'yesterday / worked / a lot / I',a:'I worked a lot yesterday.',hint:'Who first, time last.',fu:'True for you? What did you do a lot yesterday?'},
    {t:'us',q:'didn\'t / we / TV / watch / night / last',a:'We didn\'t watch TV last night.',hint:'didn\'t before the verb.',fu:'What did you do last night instead?'},
    ...
    {t:'tr',q:'Make it past: "I play with my dog every day." (yesterday version)',a:'I playED with my dog yesterday.',hint:'verb + ed, swap the time word.',fu:'What did you play/do with someone yesterday?'},
  ...
  makeit:['Yesterday I ______ — and it was great/terrible!','Last weekend, my family and I...','I ______ (verb+ed) for hours last week!','One thing I planned but DIDN\'T do this week...','The last time I laughed a lot: I was with ______ and we...','Ask ME: "Did you...?" — about my yesterday!'],
  task:{
    title:'The Alibi',
  ...
  exit:[
    {tag:'🗣 speak',q:'Yesterday in 4 sentences: morning, afternoon, evening, night.'},
